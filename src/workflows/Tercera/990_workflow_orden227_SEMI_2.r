...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 202101, 202102, 202103, 202104, 202103)
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    #202006,
    202005, 202002, 202001, 201912, 201911, 201911,                            
...
#mis meses  
  param_local$train$training <- c(202105,
    #202104, 202103, 
    202102, 202101, 202012, 202011, 202010, 202009, 202008,
    202007, 
    #202006,
    202005, 202002,
  ...
  param_local$train$undersampling <- 0.06
...
wf_SEMI_ago_orden227_2 <- function( pnombrewf )
{
