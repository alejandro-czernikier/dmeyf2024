...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202106, 202105, 202104,
    202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005)
...
wf_agosto_4_similexpcol4_lag1 <- function( pnombrewf )
{
